...
{
    public partial class UyeSilmeIslemi : Form
    {
        public UyeSilmeIslemi()
        {
            InitializeComponent();
        }
        ...
        private void UyeSilmeIslemi_Load(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0) 
            {
                try
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        string query = "DELETE FROM Uye WHERE tc = @tc";
